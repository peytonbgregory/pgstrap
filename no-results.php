...
<section class="no-results not-found">
	<header class="page-header">
		<h1 class="page-title"><?php __( 'Nothing Found', 'upbootwp' ); ?></h1>
	</header><!-- .page-header -->
	...
	<div class="page-content">
		...
		<?php elseif ( is_search() ) : ?>
			...
			<p><?php __( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.' ); ?></p>
			<?php get_search_form(); ?>
