...
<hr />
<h4><a style="text-decoration:none; color:#ccc;" href="http://www.peytongregory.com" target="_blank" title="Peyton Gregory WordPress Developer">PGStrap &copy; <?php echo date("Y"); ?> | Version <?php
